package com.nickdieda.pythonlearn.Lessons.pyfile;
...
public class WFile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wfile);
...
*/
        ...
        String tt = "Writing and Creating Files in Python";
        title.setText(tt);
