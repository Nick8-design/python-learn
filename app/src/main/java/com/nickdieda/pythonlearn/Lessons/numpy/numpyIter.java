...
public class numpyIter extends AppCompatActivity {
    private CodeEditor pd0,pd00,pd1, pd2,pd3,pd4,pd5,pd7,pd6,pd8,pd9,pd10;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_numpy_iter);
