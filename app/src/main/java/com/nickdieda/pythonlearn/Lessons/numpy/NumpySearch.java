...
public class NumpySearch extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_numpy_search);
        ...
        pd00 = findViewById(R.id.pd00);
        pd000 = findViewById(R.id.pd000);
...
*/
        ...
        CodeLang.pyLangstatic(getApplicationContext(),pd00);
        CodeLang.pyLangstatic(getApplicationContext(),pd000);
